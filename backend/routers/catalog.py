...
INGREDIENTS = [
    ...
    _ingredient("idli", "Idli", "Prepared Breakfast", (128, 4.5, 25, 0.5, 1.5, 250, 1, 15)),
    _ingredient("medu-vada", "Medu Vada", "Prepared Breakfast", (310, 12, 32, 15, 5, 400, 3, 60)),
    ...
    _ingredient("appam", "Appam", "Prepared Breakfast", (120, 2.5, 25, 1.5, 0.8, 180, 0.5, 10)),
    ...
    _ingredient("aloo-paratha", "Aloo Paratha", "Prepared Breakfast", (230, 6, 34, 8, 4, 400, 2.5, 45)),
...
RECIPES.extend([
    ...
    _breakfast_recipe("idli", "Steamed Idli", "Tamil Nadu", "Soft fermented rice-and-urad cakes with a light steamed finish.", "steaming", 160),
    _breakfast_recipe("medu-vada", "Medu Vada", "South India", "Savory urad dal rings fried until crisp outside and fluffy within.", "deep_frying", 150),
    ...
    _breakfast_recipe("appam", "Kerala Appam", "Kerala", "Lacy fermented rice pancakes with a soft, bowl-shaped centre.", "frying", 180),
    ...
    _breakfast_recipe("aloo-paratha", "Aloo Paratha", "Punjab", "Whole-wheat flatbread stuffed with spiced potato and cooked on a tawa.", "frying", 220),
