...
INGREDIENTS = [
    ...
    _ingredient("soya-chunks", "Soya Chunks", "Pulses", (345, 52, 33, 0.5, 13, 15, 20, 350)),
    ...
    _ingredient("medium-roti", "Medium Roti (Chapati)", "Grains", (297, 9.7, 55.8, 6, 7, 300, 3, 25), "pieces_count", 40),
    _ingredient("medium-jonna-roti", "Medium Jonna Roti (Jowar Roti)", "Grains", (260, 8.5, 55, 2.5, 7, 20, 3.4, 25), "pieces_count", 60),
    ...
    _ingredient("cold-pressed-groundnut-oil", "Cold-Pressed Groundnut Oil", "Oils & Fats", (884, 0, 0, 100, 0, 0, 0, 0), "tablespoons", tablespoon_weight_g=14),
    _ingredient("cold-pressed-coconut-oil", "Cold-Pressed Coconut Oil", "Oils & Fats", (892, 0, 0, 100, 0, 0, 0, 0), "tablespoons", tablespoon_weight_g=14),
    ...
    _ingredient("plain-dosa", "Plain Dosa", "Prepared Breakfast", (168, 4.5, 30, 3.7, 1, 310, 1.2, 20), "pieces_count", 100),
    _ingredient("masala-dosa", "Masala Dosa", "Prepared Breakfast", (200, 4.5, 30, 7, 2.5, 350, 1.2, 30)),
    _ingredient("idli", "Idli", "Prepared Breakfast", (128, 4.5, 25, 0.5, 1.5, 250, 1, 15), "pieces_count", 40),
    _ingredient("medu-vada", "Medu Vada", "Prepared Breakfast", (310, 12, 32, 15, 5, 400, 3, 60), "pieces_count", 50),
    _ingredient("upma", "Upma", "Prepared Breakfast", (120, 3, 21, 3.5, 2, 250, 0.8, 20)),
    _ingredient("ven-pongal", "Ven Pongal", "Prepared Breakfast", (140, 5, 22, 4, 2, 300, 1.2, 35)),
    _ingredient("uttapam", "Uttapam", "Prepared Breakfast", (170, 5, 28, 4, 2, 300, 1.2, 30)),
    _ingredient("appam", "Appam", "Prepared Breakfast", (120, 2.5, 25, 1.5, 0.8, 180, 0.5, 10), "pieces_count", 50),
    _ingredient("puttu", "Puttu", "Prepared Breakfast", (180, 3.5, 38, 1.5, 3, 200, 1, 15)),
    _ingredient("pesarattu", "Pesarattu", "Prepared Breakfast", (160, 8, 25, 3, 4, 250, 2, 40)),
    _ingredient("poori-bhaji", "Poori Bhaji", "Prepared Breakfast", (250, 5, 30, 13, 3, 350, 2, 30)),
    _ingredient("poori", "Poori", "Prepared Breakfast", (296, 7, 38, 13, 2, 360, 2.5, 25), "pieces_count", 20),
    _ingredient("aloo-paratha", "Aloo Paratha", "Prepared Breakfast", (230, 6, 34, 8, 4, 400, 2.5, 45), "pieces_count", 100),
    _ingredient("chole-bhature", "Chole Bhature", "Prepared Breakfast", (300, 10, 40, 12, 6, 500, 3.5, 60)),
    _ingredient("bedmi-poori", "Bedmi Poori", "Prepared Breakfast", (320, 9, 38, 16, 5, 450, 3, 50)),
    _ingredient("breakfast-poha", "Kanda Poha", "Prepared Breakfast", (150, 4, 28, 3, 3, 300, 4, 25)),
    _ingredient("sabudana-khichdi", "Sabudana Khichdi", "Prepared Breakfast", (190, 3, 32, 6, 2, 250, 1, 20)),
    _ingredient("misal-pav", "Misal Pav", "Prepared Breakfast", (180, 8, 28, 5, 6, 500, 3, 60)),
    _ingredient("dhokla", "Khaman Dhokla", "Prepared Breakfast", (160, 8, 28, 2, 3, 350, 2, 50)),
    _ingredient("thepla", "Methi Thepla", "Prepared Breakfast", (220, 7, 32, 8, 5, 450, 3, 80)),
    _ingredient("khandvi", "Khandvi", "Prepared Breakfast", (170, 8, 18, 7, 2, 450, 2, 70)),
    _ingredient("luchi-aloo", "Luchi with Aloo Dum", "Prepared Breakfast", (280, 5, 35, 13, 3, 400, 2, 30)),
    _ingredient("ghugni", "Ghugni", "Prepared Breakfast", (140, 7, 24, 2, 6, 350, 2.5, 50)),
    _ingredient("litti-chokha", "Litti Chokha", "Prepared Breakfast", (240, 8, 40, 6, 7, 400, 3.5, 60)),
    _ingredient("ragi-dosa", "Ragi Dosa", "Prepared Breakfast", (170, 5, 30, 3.5, 4, 280, 3, 120)),
    ...
    _ingredient("egg", "Egg", "Non-veg", (143, 12.6, 0.7, 9.5, 0, 142, 1.8, 56), "pieces_count", 50, b12=1.1),
...
def _breakfast_recipe(
    ...
    return Recipe(
        id=f"breakfast-{food_id}",
        name=name,
        region=region,
        description=description,
        meal_type="Breakfast",
        dietary_type="Vegetarian",
        default_cooking_method=cooking_method,
        ingredients=[{"ingredient_id": food_id, "quantity": portion, "unit": unit}],
    )


RECIPES.extend([
    _breakfast_recipe("plain-dosa", "Classic Plain Dosa", "South India", "Crisp fermented rice-and-lentil crepe served hot from the tawa.", "frying", 1, "pieces_count"),
    _breakfast_recipe("masala-dosa", "Masala Dosa", "Karnataka", "Golden dosa folded around a warmly spiced potato masala.", "frying", 250),
    _breakfast_recipe("idli", "Steamed Idli", "Tamil Nadu", "Soft fermented rice-and-urad cakes with a light steamed finish.", "steaming", 4, "pieces_count"),
    _breakfast_recipe("medu-vada", "Medu Vada", "South India", "Savory urad dal rings fried until crisp outside and fluffy within.", "deep_frying", 3, "pieces_count"),
    _breakfast_recipe("upma", "Vegetable Upma", "Karnataka", "Roasted semolina cooked with vegetables, mustard, and curry leaves.", "sauteing", 220),
    _breakfast_recipe("ven-pongal", "Ven Pongal", "Tamil Nadu", "Comforting rice and moong dal tempered with cumin, pepper, and ghee.", "pressure_cooking", 240),
    _breakfast_recipe("uttapam", "Vegetable Uttapam", "South India", "Thick fermented pancake topped with onion, tomato, and chilli.", "frying", 220),
    _breakfast_recipe("appam", "Kerala Appam", "Kerala", "Lacy fermented rice pancakes with a soft, bowl-shaped centre.", "frying", 3, "pieces_count"),
    _breakfast_recipe("puttu", "Kerala Puttu", "Kerala", "Steamed cylinders of rice flour layered with fresh coconut.", "steaming", 200),
    _breakfast_recipe("pesarattu", "Andhra Pesarattu", "Andhra Pradesh", "Protein-rich green moong crepe with ginger and green chilli.", "frying", 200),
    _breakfast_recipe("poori-bhaji", "Poori Bhaji", "North India", "Puffed wheat pooris paired with a gently spiced potato bhaji.", "deep_frying", 250),
    _breakfast_recipe("poori", "Plain Poori", "North India", "Small wheat pooris puffed in hot oil until crisp and golden.", "deep_frying", 3, "pieces_count"),
    _breakfast_recipe("aloo-paratha", "Aloo Paratha", "Punjab", "Whole-wheat flatbread stuffed with spiced potato and cooked on a tawa.", "frying", 2, "pieces_count"),
    _breakfast_recipe("chole-bhature", "Chole Bhature", "Punjab", "Spiced chickpeas served with fluffy deep-fried bhature.", "deep_frying", 300),
    _breakfast_recipe("bedmi-poori", "Bedmi Poori", "Uttar Pradesh", "Crisp urad-spiced pooris traditionally served with potato curry.", "deep_frying", 220),
    _breakfast_recipe("breakfast-poha", "Kanda Poha", "Maharashtra", "Flattened rice tossed with onion, mustard seeds, turmeric, and lemon.", "sauteing", 220),
    _breakfast_recipe("sabudana-khichdi", "Sabudana Khichdi", "Maharashtra", "Tapioca pearls tossed with peanuts, potato, cumin, and lemon.", "sauteing", 220),
    _breakfast_recipe("misal-pav", "Misal Pav", "Maharashtra", "Sprouted-bean curry with spicy tarri, farsan, and soft pav.", "boiling", 280),
    _breakfast_recipe("dhokla", "Khaman Dhokla", "Gujarat", "Light, tangy gram-flour cakes steamed and mustard-tempered.", "steaming", 180),
    _breakfast_recipe("thepla", "Methi Thepla", "Gujarat", "Thin fenugreek flatbreads cooked on a tawa for a savory breakfast.", "frying", 180),
    _breakfast_recipe("khandvi", "Khandvi", "Gujarat", "Silky gram-flour and yogurt rolls finished with mustard tempering.", "steaming", 160),
    _breakfast_recipe("luchi-aloo", "Luchi Aloo Dum", "West Bengal", "Fluffy refined-flour breads with a fragrant Bengali potato curry.", "deep_frying", 260),
    _breakfast_recipe("ghugni", "Bengali Ghugni", "West Bengal", "Yellow peas simmered with ginger, tomato, and warming spices.", "boiling", 240),
    _breakfast_recipe("litti-chokha", "Litti Chokha", "Bihar", "Roasted wheat-and-sattu dumplings with smoky mashed vegetables.", "roasting", 250),
    _breakfast_recipe("ragi-dosa", "Ragi Dosa", "Karnataka", "Crisp finger-millet dosa with an earthy, fiber-rich batter.", "frying", 180),
])
